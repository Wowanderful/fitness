...
},{"./accordion/init-accordion":2,"./modules/button":4,"./modules/form-validate/form":6,"./modules/modals/init-modals":12,"./modules/playvideo":14,"./modules/slider":15,"./tabs/init-tabs":16,"./utils/ios-vh-fix":20}],4:[function(require,module,exports){
"use strict";
...
var videoContainer = document.querySelector('.gym-video__container');
var button = document.querySelector('.button-play');
var poster = document.querySelector('.gym__video-preload');
...
var feedbackSlider = new _swiper.default('.feedback-slider', {
  cssMode: true,
  loop: false,
  direction: 'horizontal',
  slidesPerView: 1,
...
var swiperArray = [];
exports.swiperArray = swiperArray;
